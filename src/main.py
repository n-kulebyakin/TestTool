...
class MainWindow(QMainWindow):
    ...
    ils_path = ('X:/projects/mosgd/MMK/serebryanyi_bor' +
                '/eqv/ipu7/ILS2_RF_SBO-RBCUR/ILS2_RF_SBO')
    site_keys = {}
    visual_objects = {}
    ...
    def __init__(self):
        ...
        #self.color_window = ObjectColorWindow(self.objects_colors, self.visual_objects)
